...
| LLM provider | OpenAI API (`OPENAI_MODEL`, default `gpt-5.6-sol`) | Claude API; Groq and OpenRouter free tiers; Ollama for local development only |
